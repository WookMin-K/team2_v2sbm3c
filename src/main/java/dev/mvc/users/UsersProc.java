...
public class UsersProc implements UsersProcInter {
  ...
  public List<UsersVO> listWithPaging(Map<String, Object> map) {
    return this.usersDAO.listWithPaging(map);
  }

  @Override
  public int countAll(Map<String, Object> map) {
    return this.usersDAO.countAll(map);
  }

  @Override
  public int updateProfileUrl(UsersVO usersVO) {
    return this.usersDAO.updateProfileUrl(usersVO);
  }

  @Override
  public int checkSnsId(String provider_no) {
    return usersDAO.checkSnsId(provider_no);
  }
